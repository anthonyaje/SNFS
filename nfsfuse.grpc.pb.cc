...
NFS::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_nfsfuse_rmdir_(NFS_method_names[6], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_nfsfuse_unlink_(NFS_method_names[7], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status NFS::Stub::nfsfuse_rmdir(::grpc::ClientContext* context, const ::nfsfuse::String& request, ::nfsfuse::MkdirOutput* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_nfsfuse_rmdir_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::nfsfuse::MkdirOutput>* NFS::Stub::Asyncnfsfuse_rmdirRaw(::grpc::ClientContext* context, const ::nfsfuse::String& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::nfsfuse::MkdirOutput>(channel_.get(), cq, rpcmethod_nfsfuse_rmdir_, context, request);
}

::grpc::Status NFS::Stub::nfsfuse_unlink(::grpc::ClientContext* context, const ::nfsfuse::String& request, ::nfsfuse::MkdirOutput* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_nfsfuse_unlink_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::nfsfuse::MkdirOutput>* NFS::Stub::Asyncnfsfuse_unlinkRaw(::grpc::ClientContext* context, const ::nfsfuse::String& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::nfsfuse::MkdirOutput>(channel_.get(), cq, rpcmethod_nfsfuse_unlink_, context, request);
}
...
NFS::Service::Service() {
  ...
  AddMethod(new ::grpc::RpcServiceMethod(
      NFS_method_names[6],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< NFS::Service, ::nfsfuse::String, ::nfsfuse::MkdirOutput>(
...
::grpc::Status NFS::Service::nfsfuse_rmdir(::grpc::ServerContext* context, const ::nfsfuse::String* request, ::nfsfuse::MkdirOutput* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status NFS::Service::nfsfuse_unlink(::grpc::ServerContext* context, const ::nfsfuse::String* request, ::nfsfuse::MkdirOutput* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
