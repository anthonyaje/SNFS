...
class NFS GRPC_FINAL {
 public:
  ...
  typedef WithAsyncMethod_nfsfuse_getattr<WithAsyncMethod_nfsfuse_readdir<WithAsyncMethod_nfsfuse_open<WithAsyncMethod_nfsfuse_read<WithAsyncMethod_nfsfuse_write<WithAsyncMethod_nfsfuse_mkdir<WithAsyncMethod_nfsfuse_rmdir<Service > > > > > > > AsyncService;
  template <class BaseClass>
