...
class NFS GRPC_FINAL {
 public:
  ...
  typedef WithAsyncMethod_nfsfuse_getattr<WithAsyncMethod_nfsfuse_readdir<WithAsyncMethod_nfsfuse_open<WithAsyncMethod_nfsfuse_read<WithAsyncMethod_nfsfuse_write<WithAsyncMethod_nfsfuse_mkdir<Service > > > > > > AsyncService;
  template <class BaseClass>
