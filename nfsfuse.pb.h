...
class FileDesc : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nfsfuse.FileDesc) */ {
 public:
  FileDesc();
  virtual ~FileDesc();

  FileDesc(const FileDesc& from);

  inline FileDesc& operator=(const FileDesc& from) {
    CopyFrom(from);
    return *this;
  }

  static const ::google::protobuf::Descriptor* descriptor();
  static const FileDesc& default_instance();

  void Swap(FileDesc* other);

  // implements Message ----------------------------------------------

  inline FileDesc* New() const { return New(NULL); }

  FileDesc* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const FileDesc& from);
  void MergeFrom(const FileDesc& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(FileDesc* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  // @@protoc_insertion_point(class_scope:nfsfuse.FileDesc)
 private:
  ...
  void InitAsDefaultInstance();
  static FileDesc* default_instance_;
};
// -------------------------------------------------------------------

class Errno : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nfsfuse.Errno) */ {
 public:
  Errno();
  virtual ~Errno();
  ...
  // @@protoc_insertion_point(class_scope:nfsfuse.Errno)
 private:
...
// optional int32 fh = 1;
inline void FileDesc::clear_fh() {
  fh_ = 0;
}
inline ::google::protobuf::int32 FileDesc::fh() const {
  // @@protoc_insertion_point(field_get:nfsfuse.FileDesc.fh)
  return fh_;
}
inline void FileDesc::set_fh(::google::protobuf::int32 value) {
